-- Supabase Database Schema for OfficeFlow
...
-- Public read access for staff (for staff directory)
CREATE POLICY "Public read access for staff" ON staff
    FOR SELECT USING (is_active = true);

-- Public read access for facilities
CREATE POLICY "Public read access for facilities" ON facilities
    FOR SELECT USING (is_active = true);

-- Public read access for public documents
CREATE POLICY "Public read access for public documents" ON documents
    FOR SELECT USING (is_public = true);

-- Public insert access for products (product registration)
CREATE POLICY "Public insert access for products" ON products
    FOR INSERT WITH CHECK (true);

-- Public read access for product status
CREATE POLICY "Public read access for product status" ON products
...
-- Admin access policies (you'll need to implement proper authentication)
...
CREATE POLICY "Admin full access bookings" ON facility_bookings
    FOR ALL USING (true);
